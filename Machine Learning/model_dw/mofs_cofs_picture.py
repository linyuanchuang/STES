...
df = pd.read_csv('mofs_cofs_result_dw.csv')
...
ax.set_ylabel('Predicted '+r'$\Delta$W (g/g)' ,fontsize=22)
ax.set_title('SVR' ,fontsize =24)
ax.text(0.016875, 0.834, R2,fontsize= 20)
ax.set_ylim(0,0.9)
...
ax3.text(0.016875, 0.834, R2,fontsize= 20)
#ax1.set_xlabel(r'$\mathrm{COP_{C}}$',fontsize=22)
ax3.set_ylabel('Predicted '+r'$\Delta$W (g/g)',fontsize=22)
ax3.set_ylim(0,0.9)
yticks = np.linspace(0,0.9,10)
ax3.set_xlim(0,0.9)
xticks = np.linspace(0,0.9,10)
...
for i in range(len(model_col)):
    if actual_col[i]>0 and model_col[i]>0:
        xx = int(actual_col[i]/0.018)    
        yy = int(model_col[i]/0.018) 
        data_imshow1[yy][xx] = data_imshow1[yy][xx] + 1    
#print(data_imshow1)
sc12 = ax12.imshow(data_imshow1,interpolation='none',origin='lower',cmap=colormap,extent=[0,0.9,0,0.9],aspect='auto',norm=matplotlib.colors.LogNorm(vmin=Z1.min(),vmax=0.5 * Z1.max()))
ax12.plot((0, 1), (0, 1), transform=ax12.transAxes, ls='--', c='k')
...
cbar1.ax.set_title('Counts', y=1,fontsize=20,fontdict=title_font)
#ax1.set_xlabel(r'$\mathrm{COP_{C}}$',fontsize=22)
ax12.set_ylabel('Predicted '+r'$\Delta$W (g/g)',fontsize=22)
ax12.set_ylim(0,0.9)
yticks = np.linspace(0,0.9,10)
ax12.set_xlim(0,0.9)
xticks = np.linspace(0,0.9,10)
...
ax12.text(0.016875, 0.834, R2,fontsize= 20)
...
ax.set_yticks(yticks)
ax.legend(loc='lower right')
ax.set_ylabel('Predicted ranks of '+r'$\Delta$W',fontsize=22)
ax.set_title('SVR' ,fontsize =24)
ax.set_xticklabels([])
SRCC = "(a) SRCC = "+ str(format(SROCC,"0.2f"))        
ax.text(37.5, 1853.333, SRCC,fontsize= 20)
...
#ax1.set_xlabel(r'$\mathrm{COP_{C}}$',fontsize=22)
ax3.set_ylabel('Predicted ranks of '+r'$\Delta$W',fontsize=22)
ax3.set_ylim(0,2000)
yticks = np.linspace(0,2000,5)
ax3.set_xlim(0,2000)
xticks = np.linspace(0,2000,5)
...
ax3.set_title('SVR' ,fontsize =24)
ax3.set_xticklabels([])
ax3.text(37.5, 1853.333, SRCC,fontsize= 20)
...
cbar1.ax.set_title('Counts', y=1,fontsize=20,fontdict=title_font)
#ax1.set_xlabel(r'$\mathrm{COP_{C}}$',fontsize=22)
ax12.set_ylabel('Predicted ranks of '+r'$\Delta$W',fontsize=22)
...
ax12.set_title('SVR' ,fontsize =24)
ax12.set_xticklabels([])
ax12.text(37.5, 1853.333, SRCC,fontsize= 20)
...
#ax1.set_xlabel(r'$\mathrm{COP_{C}}$',fontsize=22)
#ax3.set_ylabel('Predicted '+r'$\Delta$W',fontsize=22)
ax3.set_ylim(0,0.9)
yticks = np.linspace(0,0.9,10)
ax3.set_xlim(0,0.9)
xticks = np.linspace(0,0.9,10)
...
for i in range(len(model_col)):
    if actual_col[i]>0 and model_col[i]>0:
        ...
        data_imshow1[yy][xx] = data_imshow1[yy][xx] + 1    
#print(data_imshow1)
sc7 = ax2.imshow(data_imshow1,interpolation='none',origin='lower',cmap=colormap,extent=[0,0.9,0,0.9],aspect='auto',norm=matplotlib.colors.LogNorm(vmin=Z1.min(), vmax=0.5 * Z1.max()))
...
cbar1.ax.set_title('Counts', y=1,fontsize=20,fontdict=title_font)
#ax1.set_xlabel(r'$\mathrm{COP_{C}}$',fontsize=22)
#ax2.set_ylabel('Predicted '+r'$\Delta$W',fontsize=22)
ax2.set_ylim(0,0.9)
yticks = np.linspace(0,0.9,10)
ax2.set_xlim(0,0.9)
xticks = np.linspace(0,0.9,10)
...
ax2.set_xticklabels([])
ax2.set_yticklabels([])
ax2.text(0.016875, 0.834, R2,fontsize= 20)
...
#ax.set_xlabel('Actual' ,fontsize =24)
#ax.legend(loc='lower right')
#ax.set_ylabel('Predicted '+r'$\Delta$W',fontsize=22)
ax.set_title('MLP' ,fontsize =24)
ax.set_ylim(0,2000)
yticks = np.linspace(0,2000,5)
ax.set_xlim(0,2000)
...
ax2.set_xticklabels([])
ax2.set_yticklabels([])
ax2.text(37.5, 1853.333, SRCC,fontsize= 20)
...
ax.text(0.016875, 0.834, R2,fontsize= 20)
ax.plot((0, 1), (0, 1), transform=ax.transAxes, ls='--', c='k')
#ax.set_ylabel('Predict ' ,fontsize =24)
ax.set_title('HGBR' ,fontsize =24)
ax.set_xlabel(r'$\Delta$W (g/g)',fontsize=22)
ax.set_ylabel('Predicted '+r'$\Delta$W (g/g)',fontsize=22)
...
cbar1.ax.set_title('Counts', y=1,fontsize=20,fontdict=title_font)
ax3.set_ylabel('Predicted '+r'$\Delta$W (g/g)',fontsize=22)
ax3.set_xlabel(r'$\Delta$W (g/g)',fontsize=22)
ax3.set_ylim(0,0.9)
yticks = np.linspace(0,0.9,10)
ax3.set_xlim(0,0.9)
xticks = np.linspace(0,0.9,10)
...
cbar1 = plt.colorbar(sc7,cax=cax)
cbar1.ax.set_title('Counts', y=1,fontsize=20,fontdict=title_font)
ax2.set_xlabel(r'$\Delta$W (g/g)',fontsize=22)
ax2.set_ylabel('Predicted '+r'$\Delta$W (g/g)',fontsize=22)
ax2.set_ylim(0,0.9)
yticks = np.linspace(0,0.9,10)
ax2.set_xlim(0,0.9)
xticks = np.linspace(0,0.9,10)
...
#ax.set_xlabel('Actual' ,fontsize =24)
#ax.legend(loc='lower right')
ax.set_xlabel(r'Ranks of $\Delta$W',fontsize=22)
ax.set_ylabel('Predicted ranks of '+r'$\Delta$W',fontsize=22)
ax.set_title('HGBR' ,fontsize =24)
ax.set_ylim(0,2000)
yticks = np.linspace(0,2000,5)
...
ax3.set_xlabel(r'Ranks of $\Delta$W',fontsize=22)
ax3.set_ylabel('Predicted ranks of '+r'$\Delta$W',fontsize=22)
ax3.set_ylim(0,2000)
yticks = np.linspace(0,2000,5)
ax3.set_xlim(0,2000)
...
cbar1 = plt.colorbar(sc7,cax=cax)
cbar1.ax.set_title('Counts', y=1,fontsize=20,fontdict=title_font)
ax2.set_xlabel(r'Ranks of $\Delta$W',fontsize=22)
ax2.set_ylabel('Predicted ranks of '+r'$\Delta$W',fontsize=22)
ax2.set_ylim(0,2000)
yticks = np.linspace(0,2000,5)
ax2.set_xlim(0,2000)
xticks = np.linspace(0,2000,5)
...
ax8.set_xlabel(r'Ranks of $\Delta$W',fontsize=22)
ax8.set_ylim(0,2000)
yticks = np.linspace(0,2000,5)
ax8.set_xlim(0,2000)
xticks = np.linspace(0,2000,5)
...
ax8.set_yticklabels([])
ax8.text(37.5, 1853.333, SRCC,fontsize= 20)
